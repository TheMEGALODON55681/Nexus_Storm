...
def truncate_filename(filename, max_length=125):
    """Shorten a filename so it stays within filesystem path-length limits.

    Args:
        filename: The filename string to truncate.
        max_length: Maximum allowed length in characters (default 125).
    """
